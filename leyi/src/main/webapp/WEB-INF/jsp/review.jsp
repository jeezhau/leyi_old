...
<div class="container">
    ...
    <div class="col-md-12" >
      <div class="panel panel-info">
        <table class="table table-striped   table-hover ">
          <caption class="text-center"><h3><b>~文章审核~</b></h3></caption>
          <thead>
          ...
          <tbody> 
           <c:forEach items="${articles}" var="item">
            <tr>
              ...
              <td><a href="/leyi/${operator.username }/article_mgr/review/${item.id}" target="_blank">审核</a></td>
            </tr>
           </c:forEach>
          </tbody>
        </table>
  ...
  <c:if test="${fn:length(themes)>0 }">
    <div class="col-md-12" >
      <div class="panel panel-info">
        <table class="table table-striped   table-hover ">
          <caption class="text-center"><h3><b>~主题审核~</b></h3></caption>
          <thead>
   	        <tr><th>主题名称</th><th>关键词 </th><th>更新时间 </th><th>操作 </th></tr>
          </thead>
          <tbody> 
